...
export class ProductsController {
  ...
  @ApiOperation({
    ...
    description: 'Crea un nuevo producto en la tienda con su información básica e imágenes opcionales'
  })
  @ApiResponse({
    status: 201,
    ...
    examples: {
      example1: {
        ...
        value: {
          ...
          images: ['https://example.com/nike-shirt-1.jpg', 'https://example.com/nike-shirt-2.jpg']
        },
      },
      example2: {
  ...
  @ApiOperation({
    ...
    description: 'Busca un producto específico usando su UUID, título o slug. La búsqueda por título y slug es case-insensitive.'
  })
  @ApiParam({
    name: 'term',
    description: 'Término de búsqueda: UUID del producto, título completo o slug',
    examples: {
      uuid: {
  ...
  @ApiOperation({
    ...
    description: 'Actualiza parcial o completamente un producto existente. Solo se modifican los campos enviados en el body.'
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    ...
    example: {
      ...
      images: ["https://example.com/nike-premium-1.jpg", "https://example.com/nike-premium-2.jpg"]
    }
  })
  @ApiResponse({
    status: 400,
  ...
  @ApiBody({
    ...
    examples: {
      ...
      fullUpdate: {
        ...
        description: 'Ejemplo actualizando múltiples campos incluyendo imágenes',
        value: {
          title: 'Camiseta Nike Premium',
          price: 39.99,
          description: 'Camiseta de algodón premium con logo de Nike bordado',
  ...
  @ApiOperation({
    ...
    description: 'Elimina permanentemente un producto y todas sus imágenes asociadas de la base de datos.'
  })
  @ApiParam({
    name: 'id',
